...
namespace CityInfo.API.Migrations
{
    ...
    [Migration("20200412094326_DarMigration")]
    partial class DarMigration
    {
            ...
            modelBuilder.Entity("CityInfo.API.Entities.Mayor", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Age = 42, Name = "John Doe" },
                        new { Id = 2, Age = 47, Name = "Ervin Night" },
                        new { Id = 3, Age = 53, Name = "Charles Cruz" }
                    );
                });
